...
import WorkExperienceSection from "./components/sections/hybrid/Experience/ExperienceSection";
import EducationSection from "./components/sections/hybrid/Education/EducationSection";
import SkillsSection from "./components/sections/hybrid/Skill/SkillSection";
import LanguageSection from "./components/sections/hybrid/Language/LanguageSection";
import HobbiesSection from "./components/sections/hybrid/Hobby/HobbySection";
                                    ...
                                    <FormControl className="m-0 p-0">       
                                        <div className="relative border-2 border-transparent border-dashed rounded-md w-full max-w-3xl group transition-colors duration-300 hover:border-gray-300 m-0 p-0 pb-0 flex box-border h-auto">
                                            ...
                                            <textarea
                                                ...
                                                // rows={1}
                                                className="w-full min-h-[30px] text-lg text-justify font-light focus:outline-none focus:bg-gray-200 hover:bg-gray-200 transition-colors py-0.5 px-1.5 border border-transparent rounded-md resize-none overflow-hidden bg-white dark:bg-white dark:focus:bg-slate-200 dark:hover:bg-slate-200 m-0"
                                                onInput={(e) => {
